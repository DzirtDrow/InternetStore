...
//    public Response getGoods(@PathParam("id") int id){
...
//    }
    ...
    public Response getPromoLIst() {
        List<PromotionDto> promoList = new ArrayList<PromotionDto>();
        promoList.add(new PromotionDto(1,"test 4", "test desc 4"));
        promoList.add(new PromotionDto(1,"test 5", "test desc 5"));
        promoList.add(new PromotionDto(1,"test 6", "test desc 6"));
        return Response.ok(
                new GenericEntity<List<PromotionDto>>(promoList){}).build();
    }
