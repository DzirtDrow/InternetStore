        ...
        <div class="sign-in-page col-md-4 col-sm-4">
            ...
            <form action="${pageContext.request.contextPath}/login" method="post">
                <table>
                    <tr>
                        <td>Username:</td>
                        <td><input type='text' name='username' class="form-control unicase-form-control text-input"/>
                        </td>
                    </tr>
                    <tr>
                        <td>Password:</td>
                        <td><input type='password' name='password' class="form-control unicase-form-control text-input">
                        </td>
                    </tr>
